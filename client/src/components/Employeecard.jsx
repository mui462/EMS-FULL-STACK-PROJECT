...
const Employeecard = ({employee, onDelete, onEdit}) => {
    ...
    return (<div className="group relative card card-hover overflow-hidden">
                ...
                <div className="relative aspect-4/3 w-full overflow-hidden bg-linear-to-br from-slate-100 to-slate-50">
                    ...
                    <div className="absolute top-3 left-3 flex gap-2">
                        <span className="bg-white/90 background-blur-sm px-2.5 py-1 text-xs font-semibold text-slate-600 rounded-lg shadow-sm">{employee.department || "Remote"}</span>

...
const EmployeeForm = ({ initialData, onSuccess, onCancel }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            employeeData.basicSalary = Number(employeeData.basicSalary);
            employeeData.allowances = Number(employeeData.allowances);
            employeeData.deductions = Number(employeeData.deductions);
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">
            ...
            <div className="card p-5 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    ...
                    {!isEditMode && (
                        <div>
                            <label className="block mb-2">Temprary Password</label>
                    ...
                    <div>
                        <label className="block mb-2">System Rolae</label>
